      ...
      <main className="flex-1 py-12 bg-[#FAF8F5]">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <div className="mb-8 space-y-2">
            <div className="inline-flex items-center gap-1.5 text-xs font-mono text-[#2E4A3E] bg-[#E2EAE6] px-2.5 py-0.5 rounded font-semibold uppercase">
              Found Item Turn-in
            </div>
            ...
            <p className="text-sm text-[#72787E]">
              Thank you for helping return lost items to their owners. Uploading a photo enables instant YOLO object detection and EasyOCR text extraction for accurate matching.
            </p>
          </div>
            ...
            <div className="custom-card rounded-xl p-8 bg-white text-center space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-[#72787E] max-w-md mx-auto">
                  Your report has been indexed in Atlas Vector Search. The LangGraph agent is matching this against open lost item reports.
                </p>
              </div>
              <div className="flex justify-center gap-4 pt-4">
                ...
                >
                  View Candidate Owners <ArrowRight size={16} />
                </a>
                <a
                  href="/dashboard"
            ...
            <form onSubmit={handleSubmit} className="custom-card rounded-xl p-6 sm:p-8 bg-white space-y-6">
              ...
              <div>
                <label className="block text-xs font-semibold text-[#1E2022] uppercase tracking-wider mb-2">
                  Item Photo (Enables YOLO & EasyOCR Auto-Extraction)
                </label>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g. Wireless Headphones in Case"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="e.g. Student Union Plaza Bench"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="e.g. Today around 11:15 AM"
                      className="w-full pl-9 pr-3 py-2 text-sm bg-[#FAF8F5] border border-[#E5E2DC] rounded-md focus:outline-none focus:border-[#2E4A3E]"
                    />
                  </div>
                </div>
              ...
              <div>
                <label className="block text-xs font-semibold text-[#1E2022] uppercase tracking-wider mb-1">
                  Item Description & Current Storage Location
                </label>
                <textarea
                  rows={4}
                  required
                  ...
                  placeholder="Describe color, brand, condition, or which lost & found desk it was turned into..."
                  className="w-full px-3 py-2 text-sm bg-[#FAF8F5] border border-[#E5E2DC] rounded-md focus:outline-none focus:border-[#2E4A3E]"
                />
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-[#2E4A3E] text-white py-3 rounded-md font-semibold text-sm hover:bg-[#233A30] transition-colors flex items-center justify-center gap-2 shadow-sm"
              >
                {loading ? "Analyzing Image with YOLO & OCR..." : "Submit Found Item Report"}
                <ArrowRight size={16} />
              </button>
            </form>
          )}
